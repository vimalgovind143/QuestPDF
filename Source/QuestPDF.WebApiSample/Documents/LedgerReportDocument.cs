...
/// <summary>
/// Base Ledger Report Document
/// Implements common features for all ledger reports:
/// - Header with logo and date range
/// - Footer with paging and printing time
/// - Watermark support
/// - GCC region compatibility
/// </summary>
public class LedgerReportDocument : IDocument
{
    protected LedgerReportModel Model { get; }

    public LedgerReportDocument(LedgerReportModel model)
    {
        Model = model;
    }
    ...
    protected virtual void ComposeHeader(IContainer container)
    {
        container.Column(column =>
        {
            ...
            {
                column.Item().AlignCenter().Height(60).Image(logo, ImageScaling.FitArea);
            }
            ...
            // Report subtitle and date range
            ...
            // Date range
            column.Item().AlignCenter().Text($"Period: {Model.FromDate:dd-MMM-yyyy} to {Model.ToDate:dd-MMM-yyyy}")
                .FontSize(12)
                .FontColor(Colors.Grey.Darken1);
    ...
    protected virtual string GetRowBackgroundColor(LedgerDataRow dataRow)
    {
        if (dataRow.IsHighlighted)
